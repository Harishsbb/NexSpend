...
class InsightEngine {
  static List<String> generateInsights(List<Expense> expenses, List<BankAccount> accounts) {
    ...
    if (spentExpenses.isEmpty) return ["Start adding expenses to see insights!"];

    // 1. Highest spending category
    final categoryTotals = groupBy(spentExpenses, (Expense e) => e.category)
    ...
    final accountTotals = groupBy(spentExpenses, (Expense e) => e.accountId)
